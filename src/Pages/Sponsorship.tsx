...
const MEMEImages = [
  ...
  {
    src: "/meme/meme5.jpg",
    caption: "The Sailors Learning team and speakers at MEME!",
  },
];
          ...
          <div className="flex flex-col md:col-span-4 text-gray-900 dark:text-gray-200 gap-4">
            ...
            <div className="relative">
              ...
              <div className="ml-6 flex gap-4 text-gray-800 lg:items-center dark:text-gray-200 border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 rounded-xl p-4">
                ...
                <div>
                  Every spring, Sailors Learning hosts the Monmouth Exploratory Math Expo
            ...
            <div className="relative">
              ...
              <div className="ml-6 flex gap-4 text-gray-800 lg:items-center dark:text-gray-200 border-2  border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 rounded-xl p-4">
                ...
                <div>
                  Previous Sailors Learning events have all been online, due to the COVID-19
                  pandemic. At Sailors Learning, we are deeply passionate about advancing
