        ...
        <div className="grid md:grid-cols-2 md:gap-8">
          <div className="my-auto ">
            <div className="text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white pb-6 ">
              <EyeOffIcon className="h-12 w-12 mx-auto md:mx-0 my-auto mb-4 bg-gradient-to-r from-cyan-600 to-cyan-700 rounded-2xl p-2 text-white"></EyeOffIcon>
            ...
            <a href="/" className=" md:mr-4 ">
              <button className="flex md:mx-0 mx-auto drop-shadow-lg hover:scale-105 transform duration-150 ease-in-out pl-6 pr-5 py-3  md:text-lg border border-transparent text-base font-medium rounded-xl text-white bg-gradient-to-r from-cyan-600  to-cyan-700 dark:from-cyan-700 dark:to-cyan-800 select-none">
                Back to home{" "}
